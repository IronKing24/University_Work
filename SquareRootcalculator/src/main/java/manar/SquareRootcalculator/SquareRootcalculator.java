package manar.SquareRootcalculator;
...
class SquareRoot extends JFrame implements ActionListener, FocusListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        try{
           output.setText("your result is: "+ String.valueOf(SquareRootcalculator.root(a,b,c))+" ,Would you like to do another calculation");
        }
        catch(IllegalArgumentException i){
